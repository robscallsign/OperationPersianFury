...
local HypeManAnnounceMissionStart = false
local HypeManAnnounceMissionEnd = false
...
HypeMan.sendBotString = function(msg)
...
HypeMan.sendExportString = function(msg)
	socket.try(HypeMan.UDPSendSocket:sendto(msg, '127.0.0.1', 65001))
end

-- Sends a lua table as a json string to the UDP Listener in the Export lua environment running in DCS
HypeMan.sendExportTable = function(tbl)
...
HypeMan.sendDebugMessage = function(msg)
	messageTable = {}
	messageTable.messageType = 99
	messageTable.messageString = msg
	HypeMan.sendBotTable(messageTable)
end
--HypeMan.sendRangeMessage = function(msg)
--	socket.try(HypeMan.UDPSendSocket:sendto(msg, '127.0.0.1', 65001))
--end
